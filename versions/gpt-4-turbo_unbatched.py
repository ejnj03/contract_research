...
def to_gpt_input(model, file_name, steps_file_name):
    ...
    with open(file_name, 'w') as f, open(steps_file_name, 'w') as f_s:
        for number, input_sample in enumerate(samples[3:]):
...
if __name__ == '__main__':
    to_gpt_input(model="gpt-4-turbo", file_name='4_turbo_structured_output.jsonl', steps_file_name = '4_turbo_structured_output_steps.jsonl')